    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center">Kendali Surat Keluar</h5>
                ...
                <tbody>
                  ...
                  <td>
                    ...
                    <td>
                      ...
                      <a href="<?php echo site_url('KepalaSeksi/laporan_pdf/'.$surat->id_template)?>" target="_blank"><button type="button" class="btn btn-small"><i class="ri-eye-fill"></i></button></a>
                    ...
                    <td>
                      <?php 
                        if ($surat->status_kepala_seksi == 0){
                          ?><a href="<?php echo site_url('KepalaSeksi/ACCSuratKeluar/'.$surat->id_template)?>" class="btn btn-small btn-success">Input</a><?php } 
