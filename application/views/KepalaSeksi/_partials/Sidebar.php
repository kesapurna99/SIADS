...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item <?php echo $this->uri->segment(2) == '' ? 'active' : '' ?>">
    <a href="<?php echo site_url('KepalaSeksi')?>">
  ...
  <li class="nav-item">
    ...
    <ul id="persetujuan-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="<?php echo site_url('KepalaSeksi/persetujuan_disposisi')?>">
          <i class="bi bi-circle"></i><span>Disposisi Surat Masuk</span>
        </a>
      </li>
      <li>
        <a href="<?php echo site_url('KepalaSeksi/persetujuan_suratkeluar'); ?>">
