...
<?php $this->load->view('StaffTu/_partials/Sidebar') ?>
  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Input Data Surat Masuk & Disposisi</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
             ...
             <a href="<?php echo site_url('StaffTu/tambahsuratmasuk'); ?>" class="btn btn-success"  type="button">Tambah <i class="ri-add-circle-line"></i></a>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <td>
                    ...
                    <td>
                      <?php echo $surat_masuk->isi_surat ?>
                    </td>
                      <td>
                      <a href="<?php echo base_url('uploads/'.$surat_masuk->lampiran) ?>" target="_blank" class="btn btn-small"><i class="ri-eye-fill"></i></a>
  ...
  ?>
                    ...
                    <td>
                    <?php if($surat_masuk->status_disposisi == 0){?>
                    <a href="<?php echo site_url('StaffTu/tambahdisposisi_/'.$surat_masuk->nomor_surat)?>" class="btn btn-success">+ Disposisi</a> <?php }
                      else{
                        echo "sudah didisposisi";
                      }
                      ?>
                    </td>
