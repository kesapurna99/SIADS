...
<body>
<?php $this->load->view('KepalaKantor/_partials/Header.php') ?>
<?php $this->load->view('KepalaKantor/_partials/Sidebar.php') ?>
            ...
            <div class="col-xxl-4 col-md-6">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center " style="background-color: #ffff85; color :#f3a93b;">
