      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card" width="100%">
            <div class="card-body">
              <h5 class="card-title text-center">Data Disposisi 1</h5>
                  ...
                  <td>
                    ...
                    <?php 
                        if ($disposisi->status_kepala_kantor == 0){
                            ?> <a href="<?php echo site_url('KepalaKantor/ACCkepala_kantor/'.$disposisi->id_disposisi)?>" class="btn btn-success">Input</a><?php } 
