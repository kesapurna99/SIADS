  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Input Hasil Tindak Lanjut</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php 
                      if ($disposisi->status_kepala_seksi == 1 && $disposisi->status_kepala_kantor == 1 && $disposisi->status_kasubag_tu == 1){
                        if ($disposisi->status == 0){?>
                          <a href="<?php echo site_url('StaffSeksi/tambahtindak_lanjut/'.$disposisi->nomor_surat);?>" class="btn btn-success">Tindak Lanjut</a></td>
                    <?php }else{
                      echo "DONE";}}else{
