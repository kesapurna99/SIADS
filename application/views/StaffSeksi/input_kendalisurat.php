...
<?php echo validation_errors(); ?>
              ...
              <form action="<?php echo site_url('StaffSeksi/tambahkendalisurat') ?>" method="post" enctype="multipart/form-data"> 
              ...
              <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control <?php echo form_error('nomor_surat') ? 'is-invalid':'' ?>" name="nomor_surat" value="<?php echo $Kendali->no_urut + 1?>">
              ...
              <div class="row mb-3">
               ...
               <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control <?php echo form_error('pengolah') ? 'is-invalid':'' ?>" name="pengolah">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                     ...
                     <option selected value="PR.05">PR.05 - Pelaporan</option>
                      <option value="PR.05.01">PR.05.01 - Laporan Bulanan</option>
                      <option value="PR.05.02">PR.05.02 - Laporan Triwulan </option>
                      <option value="PR.05.03">PR.05.03- Laporan Semester</option>
                      <option value="PR.05.04">PR.05.04- Laporan Tahunan</option>
                     <option value="PR.06">PR.06 - Rapat Kerja</option>
                      <option value="PR.06.01">PR.06.01 - Dengan DPRD</option>
                      <option value="PR.06.02">PR.06.02 - Tingakat Kementrian</option>
                      <option value="PR.06.03">PR.06.03 - Tingkat Unit Utama (Rakernis)</option>
                    </select>
