              ...
              <form action="" method="post" enctype="multipart/form-data"> 
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="hidden" name="no_urut" value="<?php echo $surat->no_urut ?>">
                    <input type="hidden" name="id_user" value="<?php echo $surat->id_user ?>">
                ...
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php if($surat->status_kepala_kantor = 2){ ?>
                      <input type="hidden" name="status_kepala_kantor" value="0">
                   <?php } else { ?>
                    <input type="hidden" name="status_kepala_kantor" value="<?php echo $surat->status_kepala_kantor ?>">
                   <?php } 
                          if($surat->status_kepala_seksi = 2){ ?>
                      <input type="hidden" name="status_kepala_seksi" value="0">
                   <?php } else { ?>
                    <input type="hidden" name="status_kepala_seksi" value="<?php echo $surat->status_kepala_seksi ?>">
                   <?php } 
                          if($surat->status_kasubag_tu = 2){ ?>
                      <input type="hidden" name="status_kasubag_tu" value="0">
                   <?php } else { ?>
                    <input type="hidden" name="status_kasubag_tu" value="<?php echo $surat->status_kasubag_tu ?>">
                   <?php } ?>
